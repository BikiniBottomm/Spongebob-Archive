...
static_data_filter = filters.create(lambda _, __, query: query.data == "mute")
...
@pbot.on_message(filters.command(["fs", "fsub"]) & ~filters.private)
...
__help__ = """
*Force Subscribe*
• Spongebob can mute members who are not subscribed your channel until they subscribe
• When enabled I will mute unsubscribed members and show them a unmute button. When they pressed the button I will unmute them
*Setup:*
Note: First of all add me in the group as admin with ban users permission and in the channel as admin.
Note: Only creator of the group can setup me and I will not allow force subscribe again if not done so.
 
*Commmands:*
• `/fs`*:* To get the current settings.
• `/fs no/off/disable`*:* To turn of ForceSubscribe.
• `/fs <channel username>`*:* To turn on and setup the channel.
• `/fs clear`*:* To unmute all members who muted by me.
Note: `/fsub` is an alias of `/fs`
"""
