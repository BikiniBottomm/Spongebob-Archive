                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     ...
                     [
                        InlineKeyboardButton(
                             text="🗒 Source Code  ",
                             url="https://github.com/SpongebobSquarepantsKrustyKrab/spongebob")
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 254318997 and DONATION_LINK:
            update.effective_message.reply_text(
                "You can also donate to this Git in paypal"
                "[here](paypal.me/Nezoku) [kofi](ko-ti.com/nekozu)".format(DONATION_LINK),
                parse_mode=ParseMode.MARKDOWN,
            )
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Lets Cook Krabby Patty!!")
        except Unauthorized:
            LOGGER.warning(
